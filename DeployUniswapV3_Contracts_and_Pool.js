// Locally Deploy Uniswap V3 Contracts and Pool
// You will need to run this script using hardhat. 
// I attached the token contract and WETH9.json, files which are necesary for deployment below!

//DeployUniswapV3_Contracts_and_Pool.js:
...
nonfungibleTokenPositionDescriptor= await NonfungiblePositionManager.deploy(factory.address, weth.address, nonfungibleTokenPositionDescriptor.address);
console.log('NonfungiblePositionManager', nonfungibleTokenPositionDescriptor.address)

const sqrtPrice= encodePriceSqrt(1,1)

await nonfungibleTokenPositionManager.connect(owner).createAndInitializePoolIfNecessary(
    weth.address,
    goldBarCoin.address,
    500,
    sqrtPrice,
...
// This next file is a solidity contract
// GoldBarToken.sol below:
...
//and finally, here is WETH9.json:
